...
namespace MongoDB.Bson.Tests.IO
{
    ...
    public class JsonScannerTests
    {
        ...
        {
            var json = "\t ";
            var bufferedReader = new BufferedTextReader(json);
            var token = JsonScanner.GetNextToken(bufferedReader);
            Assert.AreEqual(JsonTokenType.EndOfFile, token.Type);
            Assert.AreEqual("<eof>", token.Lexeme);
            Assert.AreEqual(-1, bufferedReader.Read());
        }
        ...
        public void TestBeginObject()
        {
            ...
            Assert.AreEqual('x', bufferedReader.Read());
        }
        ...
        public void TestTrue()
        {
            ...
            Assert.AreEqual(',', bufferedReader.Read());
        }
