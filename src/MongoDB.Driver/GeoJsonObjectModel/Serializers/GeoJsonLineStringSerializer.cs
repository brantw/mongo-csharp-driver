...
namespace MongoDB.Driver.GeoJsonObjectModel.Serializers
{
    ...
    public class GeoJsonLineStringSerializer<TCoordinates> : ClassSerializerBase<GeoJsonLineString<TCoordinates>> where TCoordinates : GeoJsonCoordinates
    {
        ...
        protected override GeoJsonLineString<TCoordinates> DeserializeValue(BsonDeserializationContext context)
        {
            ...
            return (GeoJsonLineString<TCoordinates>)helper.DeserializeValue(context);
        }
        ...
        internal class Helper : GeoJsonGeometrySerializer<TCoordinates>.Helper
        {
            ...
            // constructors
            public Helper()
                : base(typeof(GeoJsonLineString<TCoordinates>), "LineString", new GeoJsonObjectArgs<TCoordinates>(), CreateMembers())
            {
            }
