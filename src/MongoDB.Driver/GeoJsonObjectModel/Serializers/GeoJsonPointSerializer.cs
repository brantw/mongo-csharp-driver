...
namespace MongoDB.Driver.GeoJsonObjectModel.Serializers
{
    ...
    public class GeoJsonPointSerializer<TCoordinates> : ClassSerializerBase<GeoJsonPoint<TCoordinates>> where TCoordinates : GeoJsonCoordinates
    {
        ...
        protected override GeoJsonPoint<TCoordinates> DeserializeValue(BsonDeserializationContext context)
        {
            ...
            return (GeoJsonPoint<TCoordinates>)helper.DeserializeValue(context);
        }
        ...
        internal class Helper : GeoJsonGeometrySerializer<TCoordinates>.Helper
        {
            ...
            // constructors
            public Helper()
                : base(typeof(GeoJsonPoint<TCoordinates>), "Point", new GeoJsonObjectArgs<TCoordinates>(), CreateMembers())
            {
            }
